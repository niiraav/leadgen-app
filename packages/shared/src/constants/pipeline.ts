...
export const PIPELINE_COLUMNS: PipelineColumn[] = [
  ...
  { id: 'interested',        label: 'Interested',      title: 'Interested',      value: 'interested',        field: 'engagement_status', status: ['interested', 'qualified'], color: '#16a34a', defaultFollowUpDays: 3 },
