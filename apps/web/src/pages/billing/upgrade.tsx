  ...
  return (
    <div className="max-w-4xl mx-auto pb-8 space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        {PLANS.map((plan) => {
          ...
          return (
            ...
            >
              {plan.popular && (
                <span className="absolute -top-2.5 left-4 bg-primary text-primary-foreground text-micro font-bold px-2.5 py-0.5 rounded-full uppercase tracking-wide">
                  Most Popular
                </span>
              )}
              ...
              {/* CTA */}
              {isCurrent ? (
                <div className="w-full rounded-lg bg-success/10 text-success text-sm font-medium py-3 text-center flex items-center justify-center gap-1.5">
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-border/30">
                <th className="text-left px-5 py-3 text-xs text-muted-foreground font-medium">Feature</th>
                <th className="text-center px-4 py-3 text-xs text-muted-foreground font-medium">Free</th>
                <th className="text-center px-4 py-3 text-xs font-medium text-foreground">Outreach</th>
              </tr>
            </thead>
            <tbody>
          ...
          {[
            ...
            <div key={row.label} className="px-5 py-3 flex items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-3 text-xs">
                ...
                <span className="text-foreground font-medium">{row.outreach}</span>
              </div>
            </div>
          ))}
        </div>
      ...
      <div className="rounded-xl border border-border/40 bg-card/50 p-5 space-y-3">
        <h3 className="text-sm font-medium text-foreground">About the 14-day trial</h3>
...
function Row({
  ...
  return (
    <tr className="border-b border-border/20 last:border-0">
      ...
      <td className="text-center px-4 py-3 text-muted-foreground">{free}</td>
      <td className="text-center px-4 py-3 text-foreground font-medium">{outreach}</td>
    </tr>
  );
}
