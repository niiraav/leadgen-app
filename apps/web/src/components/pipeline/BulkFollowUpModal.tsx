    ...
    <Portal>
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-overlay" onClick={onCancel}>
        <FocusTrap active={isOpen} focusTrapOptions={{ returnFocusOnDeactivate: true, escapeDeactivates: true, onDeactivate: onCancel }}>
          <div className="bg-card rounded-xl border border-border shadow-lg w-full max-w-sm mx-4 p-5" role="dialog" aria-modal="true" aria-labelledby="bulk-follow-up-title" onClick={(e) => e.stopPropagation()}>
            <div className="flex items-center justify-between mb-4">
              <h3 id="bulk-follow-up-title" className="text-sm font-semibold text-foreground flex items-center gap-2">
