...
| 3 | Pipeline > Lead drawer > View profile Runtime error | **FIXED** | (user) | ✓ |
| 4 | Leads page > can't change lead status | **FIXED** | (user) | ✓ |
| 5 | Lead info page doesn't load (infinite loop error) | **FIXED** | (user) | ✓ |
